...
void ShootingGame::PostRender()
{
}

void ShootingGame::GUI()
{
}

void ShootingGame::CreatePlatform()
{
	// 플랫폼 생성
...
void ShootingGame::CreateVerticalEnemy()
{
...
void ShootingGame::CreateHorizontalEnemy()
{
...
void ShootingGame::CreateSquareEnemy()
{
...
void ShootingGame::EnemyPattern()
{
	Vector3 p_pos = Player->GetPosition();
